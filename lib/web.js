...
(function() {
  ...
  exports.Router = Router = (function() {
    ...
    Router.prototype.get = function(pattern, callback) {
      return this.push('GET', pattern, callback);
    };

    Router.prototype.post = function(pattern, callback) {
      return this.push('POST', pattern, callback);
    };

    Router.prototype.put = function(pattern, callback) {
      return this.push('PUT', pattern, callback);
    };

    Router.prototype["delete"] = function(pattern, callback) {
      return this.push('DELETE', pattern, callback);
    };

    Router.prototype.head = function(pattern, callback) {
      return this.push('HEAD', pattern, callback);
    };

    Router.prototype.push = function(method, pattern, callback) {
      var _ref;
      this.patterns = (_ref = this.patterns) != null ? _ref : [];
      return this.patterns.push(new Pattern(method, pattern, callback));
    };

    Router.prototype.route = function(request, response) {
      var args, each, pattern, _i, _len, _ref;
      ...
      if (pattern != null) {
        ...
        return pattern.callback.apply(new Context(request, response, args));
      } else {
  ...
  Pattern = (function() {
    ...
    function Pattern(method, input, callback) {
      var p,
        _this = this;
      this.method = method;
      this.input = input;
  ...
  Context = (function() {
    ...
    function Context(request, response, args) {
      ...
      if (this.request.headers.cookie != null) {
        pair = qs.parse(this.request.headers.cookie, ';');
      }
    }
